...
ds_collections = {
    'refcoco_val': 'data/rec/refcoco_val.jsonl',
    'refcoco_testA': 'data/rec/refcoco_testA.jsonl',
    'refcoco_testB': 'data/rec/refcoco_testB.jsonl',
    'refcoco+_val': 'data/rec/refcoco+_val.jsonl',
    'refcoco+_testA': 'data/rec/refcoco+_testA.jsonl',
    'refcoco+_testB': 'data/rec/refcoco+_testB.jsonl',
    'refcocog_val': 'data/rec/refcocog_val.jsonl',
    'refcocog_test': 'data/rec/refcocog_test.jsonl',
}
...
class RefCOCODataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = data['image']
        text = data['sent']
        text = f"Meet all the descriptions: 1. {text}. 2. {text}. "
        bbox = data['bbox']
...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        if torch.distributed.get_rank() == 0:
            ...
            # print(f'Evaluating {ds_name} ...')
            print(f'Precision @ 1 (0.5): {correct / total_cnt} \n')
            print(f'Precision @ 1 (0.7): {correct_0_7 / total_cnt} \n')
            print(f'Precision @ 1 (0.9): {correct_0_9 / total_cnt} \n')
            summaries.append([args.checkpoint, ds_name, f'Precision @ 1 (0.5): {correct / total_cnt} \n',
                               f'Precision @ 1 (0.7): {correct_0_7 / total_cnt} \n',
                               f'Precision @ 1 (0.9): {correct_0_9 / total_cnt} \n'])
...
if __name__ == '__main__':
    ...
    prompt = "First create the segmentation mask for <ref>{}</ref>, then identify its bounding box."
