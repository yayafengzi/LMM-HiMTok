...
import argparse
from eval.seg_dataset import ReasonSegDataset
...
def main():
    ...
    parser.add_argument('--data-dir', type=str, default='./data/ReasonSeg')
    parser.add_argument('--datasets', type=str, default='reasonseg_val,reasonseg_test')
    parser.add_argument('--batch-size', type=int, default=1)
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--max-num', type=int, default=4)
    parser.add_argument('--text-mode', type=str, default='first')
    ...
    for dataset_name in dataset_names:
        ...
        ds = ReasonSegDataset(dataset_dir=args.data_dir, split=split, text_mode=args.text_mode)
