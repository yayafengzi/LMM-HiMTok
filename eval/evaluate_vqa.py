...
from eval.textvqa_eval import TextVQAAccuracyEvaluator
from tqdm import tqdm

ds_collections = {
    'vqav2_val': {
        'train': '',
        'test': 'data/eval/vqav2_val.jsonl',
        'annotation': 'data/eval/v2_mscoco_val2014_annotations.json',
        'metric': 'vqa_score',
        'max_new_tokens': 10,
    }
}
...
class VQADataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.dynamic_image_size:
            print(f"dynamic_preprocess;{self.max_num}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--coco-dir', type=str, default='./data/coco/val2014')
